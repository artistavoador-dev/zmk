...
// custom config
#define VIA_EEPROM_CUSTOM_CONFIG_ADDR                                                              \
    (VIA_EEPROM_LAYOUT_OPTIONS_ADDR + VIA_EEPROM_LAYOUT_OPTIONS_SIZE)
...
static inline uint8_t eeprom_read_byte(uint16_t addr) { return via_ee_device.raw[addr]; }
